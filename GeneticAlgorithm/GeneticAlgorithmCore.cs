...
{
    public class GeneticAlgorithmCore<T>
    {
        public GeneticAlgorithmCore(IFittnessFunction<T> fittnessFunction, ISelection<T> selection, ICrossover<T> crossover, IMutation<T> mutation, ITerminate<T> terminate)
        {
